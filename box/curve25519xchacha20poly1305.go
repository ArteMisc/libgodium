...
const (
	Curve25519XChacha20Poly1305_PublicKeyBytes = 32
...
type Curve25519XChacha20Poly1305 struct {
	godium.PrivateKey
	godium.PublicKey
}
...
func (b *Curve25519XChacha20Poly1305) Wipe() {
...
func (b *Curve25519XChacha20Poly1305) PublicKeyBytes() int {
	return Curve25519XChacha20Poly1305_PublicKeyBytes
}
func (b *Curve25519XChacha20Poly1305) SecretKeyBytes() int {
	return Curve25519XChacha20Poly1305_SecretKeyBytes
}
func (b *Curve25519XChacha20Poly1305) MacBytes() int   { return Curve25519XChacha20Poly1305_MacBytes }
func (b *Curve25519XChacha20Poly1305) NonceBytes() int { return Curve25519XChacha20Poly1305_NonceBytes }
func (b *Curve25519XChacha20Poly1305) SeedBytes() int  { return Curve25519XChacha20Poly1305_SeedBytes }
func (b *Curve25519XChacha20Poly1305) BeforeNmBytes() int {
	return Curve25519XChacha20Poly1305_BeforeNmBytes
}
