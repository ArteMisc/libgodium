...
func NewCurve25519XSalsa20Poly1305(private, public []byte) (box godium.Box) {
	box = &Curve25519XSalsa20Poly1305{
		PrivateKey: core.Copy(private, Curve25519XSalsa20Poly1305_SecretKeyBytes),
		PublicKey:  core.Copy(public, Curve25519XSalsa20Poly1305_PublicKeyBytes),
	}
	return
}
...
func (b *Curve25519XSalsa20Poly1305) SealDetached(dst, dstMac, nonce, plain []byte, remote godium.PublicKey) (cipher, mac []byte) {
	cipher, mac = b.BeforeNM(remote).SealDetached(dst, dstMac, nonce, plain)
	return
}

func (b *Curve25519XSalsa20Poly1305) Seal(dst, nonce, plain []byte, remote godium.PublicKey) (cipher []byte) {
...
func (b *Curve25519XSalsa20Poly1305) BeforeNM(remote godium.PublicKey) (sb godium.SecretBox) {
	var s []byte
	var key []byte
	var zero [16]byte
